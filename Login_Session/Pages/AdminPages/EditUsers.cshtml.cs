...
namespace Login_Session.Pages.AdminPages
{
    public class EditUsersModel : PageModel
    {
        ...
        public List<User> UserToEdit { get; set; } //this variable is a list to collect the selected modules to be deleted
        public List<User> NewInput { get; set; } //intentended to hold the input to change old name
        ...
        public EditUsersModel(IWebHostEnvironment env)
        {
            _env = env;
        }
